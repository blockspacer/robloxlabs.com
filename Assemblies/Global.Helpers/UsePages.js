...
const UsePages = (app, opts, PagesOpts) => {
    return new Promise((r) => {
        ...
        if (!fs_1.default.existsSync(path)) {
            Roblox_Util_FastLog_1.FASTLOGS(Roblox_Util_FastLog_1.FLog['Pages'], `[FLog::Pages] The directory %s was not found, make sure you configured your directory correctly. Static pages, so this will that return ctx::resumeFunc()`, path);
        }
