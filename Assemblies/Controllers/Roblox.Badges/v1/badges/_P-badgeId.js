...
exports.default = {
    ...
    func: async (_req, res) => {
        if (_req.method === 'OPTIONS')
            return res.send();
        if (_req.method === 'GET') {
            axios_1.default.get('https://badges.roblox.com' + _req.url, {
                ...
                .catch((e) => {
                const newheaders = JSON.parse(JSON.stringify(e.response ? e.response.headers : e)
                    .split('roblox.com')
            ...
            axios_1.default.patch('https://badges.roblox.com' + _req.url, _req.body, {
                headers: { ..._req.headers, host: 'badges.roblox.com' },
            })
                .then((re) => {
                const newheaders = JSON.parse(JSON.stringify(re.headers).split('roblox.com').join('sitetest4.robloxlabs.com'));
