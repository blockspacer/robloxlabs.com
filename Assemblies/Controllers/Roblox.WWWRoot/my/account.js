...
exports.default = {
    method: 'all',
    func: (req, res) => {
        axios_1.default.get(`https://www.roblox.com/my/account`, { headers: { ...req.headers, host: 'www.roblox.com' } })
            .then((re) => {
            const newbody = re.data
                .split('roblox.com')
                .join('sitetest4.robloxlabs.com')
                .replace('<meta id="roblox-display-names" data-enabled="false"></meta>', '<meta id="roblox-display-names" data-enabled="true"></meta>')
