...
exports.default = {
    ...
    func: async (_req, res) => {
        if (_req.method === 'OPTIONS')
            return res.send();
        if (_req.method === 'GET') {
            axios_1.default.get('https://groups.roblox.com' + _req.url, {
            ...
            axios_1.default.delete('https://groups.roblox.com' + _req.url, {
                headers: { ..._req.headers, host: 'groups.roblox.com' },
            })
                .then((re) => {
                const newheaders = JSON.parse(JSON.stringify(re.headers).split('roblox.com').join('sitetest4.robloxlabs.com'));
            ...
            axios_1.default.post('https://groups.roblox.com' + _req.url, _req.body, {
                headers: { ..._req.headers, host: 'groups.roblox.com' },
            })
                .then((re) => {
                const newheaders = JSON.parse(JSON.stringify(re.headers).split('roblox.com').join('sitetest4.robloxlabs.com'));
