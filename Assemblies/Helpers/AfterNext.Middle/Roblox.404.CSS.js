...
exports.default = (req, res) => {
    if (!req.query.apiKey)
        return res
            ...
            .send(`<Error><Code>AccessDenied</Code><Message>Access to ${'https://css.sitetest4.robloxlabs.com' + escape_html_1.default(req.url)} has been denied.</Message><HostId>${crypto_1.default
            .createHash('sha256')
